...
CURRENT_DELTA: NACHA-RULE-METADATA remains PARTIAL. Runtime ordinary TransactionCode authority, supported ordinary outbound static layout authority, ordinary inbound preselection authority, CENIT published cardinality, and official-profile version workflow are CLOSED. Inbound postselection static parser validation, direct/global DbContext immutability hardening, and unrelated CTX debt remain open.
