...
REMAINING_STATIC_LAYOUT_AUTHORITY: Outbound exact-layout static validation remains OPEN. Inbound static physical/selector authority remains OPEN.
CURRENT_DELTA: NACHA-RULE-METADATA remains PARTIAL. Runtime ordinary TransactionCode authority and ACH outbound T7 semantic selector authority are CLOSED. Remaining static layout authority, explicit official-profile version workflow, direct/global DbContext immutability hardening, and unrelated CTX debt remain open.
