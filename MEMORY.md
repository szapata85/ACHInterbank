...
CURRENT_DELTA: NACHA-RULE-METADATA remains PARTIAL. Runtime ordinary TransactionCode authority, supported ordinary outbound static layout authority, ordinary inbound preselection authority, CENIT published cardinality, official-profile version workflow, and direct/global tracked AchDbContext publication immutability are CLOSED. Inbound postselection static parser validation and unrelated CTX debt remain open.
