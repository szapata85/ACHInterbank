...
INBOUND_TXCODE_PUBLICATION_BASELINE: CLOSED — ACH ordinary inbound 35.1/V35 and CENIT PPD/CCD/CTX inbound 1.1/2026-05-07 now have six immutable PUBLISH successors with complete 12-tuple T6 contracts. The 35.0/1.0 predecessors and snapshots remain unchanged; chamber-scoped codes agree with outbound, physical layouts and focused reader results match, and canonical ingestion remains pinned to 35.0/1.0. Static inbound flow lists remain until the preselection cutover; schema, migration, and snapshot format are unchanged. Evidence: four new focused tests passed; backend CI-equivalent 2625 passed, 0 failed, 15 skipped, 2640 total; Release solution build 8 projects, 0 warnings, 0 errors.
REMAINING_STATIC_LAYOUT_AUTHORITY: Inbound static physical/selector authority remains OPEN; its immutable inbound TXCODE prerequisite is CLOSED. Next: NACHA-RULE-METADATA-STATIC-LAYOUT-AUTHORITY.INBOUND-PRESELECTION-CUTOVER.
CURRENT_DELTA: NACHA-RULE-METADATA remains PARTIAL. Runtime ordinary TransactionCode authority and supported ordinary outbound static layout authority are CLOSED. Inbound static layout authority, explicit official-profile version workflow, direct/global DbContext immutability hardening, and unrelated CTX debt remain open.
