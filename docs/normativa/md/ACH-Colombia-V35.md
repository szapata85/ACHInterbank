...
Política Cifrado de información y Controles Criptográficos – GIR-GRI-
POL- 015
...
```
NOMBRE (S) Luis Carlos Rico Luis Carlos Rico Leidy Viviana Rojas
```
```
CARGO (S)
Especialista EEV
...
Especialista EEV
Transferencias
Líder EEV Transferencias
```
```
FECHA Abril de 2026 Abril de 2026 Abril de 2026
```
```
...
1 a la 2 Enero de 2009 Se incluye Capítulo 3. Gestión del Riesgo y Seguridad de la Información.
```
...
5 a la 6 Julio de 2014 De^ conformidad^ con^ la^ solicitud^ realizada^ por^ parte^ de^ su^ Entidad^ Financiera^ en^
...
```
9 a la 10 Abril de 2018
```
- Actualización de los numerales 2.4.1 actividades ciclo de proceso, 2.4.
...
```
32 a la 33 Agosto de 2025
```
- Inclusión conceptos en Anexo 16
- Ajuste numeral. 2.11.4.2 Plazos para iniciar prenotificación
- Inclusión Causal D33 en Anexo 3. Causales de Devolución por Operador
- Inclusión: Actividad Depósito Electrónico. Numeral 2.11.3. Requisitos
    para la vinculación de usuarios originadores.

```
33 a la 34 Enero de 2026
```
- Ajuste numeral 2.12.3. Montos para transacciones débito.
- Ajuste numeral 2.12.3. Montos para monedero electrónico.
...
```
34 a la 35 Abril de 2026
```
- Se relaciona Política Cifrado de información y Controles Criptográficos – GIR-
    GRI-POL- 015.
- Ajuste al numeral 5.1.5. Certificados Digitales
- Inclusión del numeral 2.4.2. Configuración del SFTP para Envió y Recepción
...
DOMINIO DE CORREO: _Escribir los dominios de correos de usuarios de la entidad y externos que requieran_
         ...
         - VERSIÓN
      - Abril del Copyright © ACH COLOMBIA S.A
   - Página 12 de
...
- 2.2.1.1. Representante legal del participante
      ...
      - Abril del Copyright © ACH COLOMBIA S.A
   - Página 13 de
- 2.2.1.2. Administrador de Usuarios ante ACH COLOMBIA Información de carácter Confidencial
- 2.2.2. Inclusión de novedades en el sistema INTEGRA ACH
- 2.2.2.1. Manejo de Novedades
...
- 2.4.2. Configuración del SFTP para Envió y Recepción de archivos Automáticamente
- 2.4.3. Envío de archivos hacia ACH COLOMBIA
- 2.4.4. Cierre de ciclo
- 2.4.5. Entrega de planillas de compensación
- 2.4.6. Pago de compensación
- 2.4.7. Liberación de archivos
- 2.4.8. Transacciones para enviar en cada ciclo
...
- 2.7.3. Manejo de reclamos
      ...
      - Abril del Copyright © ACH COLOMBIA S.A
   - Página 14 de
- 2.7.3.1. Responsabilidades de los Participantes Información de carácter Confidencial
...
- 2.7.4. Manejo de solicitudes de certificación
...
- 2.10.1. Esquema general de operación transacción crédito
      ...
      - Abril del Copyright © ACH COLOMBIA S.A
   - Página 15 de
- 2.10.2. Flujo de la transacción crédito Información de carácter Confidencial
...
- 2.10.5. Actividades para realizar para el proceso crédito
...
- 2.12. Límites
- 2.1Para transacciones crédito
- 2.12.1. Administración de Cuentas Para Montos Superiores
- 2.12.1.1. Registrar Cuenta
- 2.12.1.2. Aprobar Cuenta
- 2.12.1.3. Cargue de archivo Nacha-M
- 2.12.2. Para transacciones débito
...
- 3.4.2. Producción de Reportes de Liquidación de Sanciones
      ...
      - Abril del Copyright © ACH COLOMBIA S.A
   - Página 16 de
- 3.5. Oportunidad y requisitos para oponerse a la sanción Información de carácter Confidencial
...
- 4.1. Administración del riesgo de lavado de activos y financiación del terrorismo (SARLAFT)
...
- 4.5.1.5. Problemas de Encriptación o Certificados de Archivos Nacha -m
...
- 5.4.1.1. Red de comunicaciones
         - VERSIÓN
      - Abril del Copyright © ACH COLOMBIA S.A
   - Página 17 de
- 5.4.2. Recomendaciones con usuarios originadores y receptores Información de carácter Confidencial
- 5.4.3. Recomendaciones en el participante
- 5.4.4. Uso de contingencias de comunicaciones
- 6. FORMATO NACHA-M
- 6.1. Generalidades del Formato
- 6.1.1. Antecedentes
- 6.1.2. Estructura de los archivos
- 6.1.3. Secuencia de los registros
- 6.1.4. Tipos de datos del formato NACHA-M
...
- 6.8. Ficha Técnica Transacción Crédito generada por PSE
      ...
      - Abril del Copyright © ACH COLOMBIA S.A
   - Página 18 de
- 6.8.1. Consideraciones generales Información de carácter Confidencial
...
- DOMINIO DE CORREO:
- transferencias interbancarias. Ejm: Banco Rojo Sufijo: banco rojo usuario/banco rojo SUFIJO DE USUARIOS: Escribir el sufijo que el usuario de la entidad requiere para acceder al servicio de
- SUFIJO DE USUARIOS:
...
Información de carácter Confidencial
```
ANEXO 20. Formulario de seguridad para vinculación de entidades participantes 290
ANEXO 21. Guía Generación Mensaje Encriptado. 312
ANEXO 22. FOMATO DE APROBACIÓN CUENTAS MONTOS SUPERIORES 316
ANEXO 23. Guía Plazos de solución a Revisiones y Devoluciones 314
...
Página 20 de 329
```
###### ESQUEMA GENERAL TABLA DE CONTENIDO
...
3.3 Solución de conflictos
3.4 Procedimiento
3.53.6 Oportunidad y requisitos para oponerse a la sanciónOtros motivos de inconformidad con los reportes de
liquidación
3.7 Excepciones
3.8 Eventos sancionables
```
...
6.2 Flujograma de Transacciones
6.3 Ficha Técnica Archivos ACH
6.46.5 Ficha Técnica Transacción CréditoFicha Técnica Transacción Débito
```
```
2.1 Características del Servicio
2.2 Autorizaciones en ACH COLOMBIA
...
6.7 Ficha Técnica Transacción Devolución por Operador
6.8 Ficha Técnica Transacción Crédito generada por PSE
6.96.10 Archivo de pagos NACHA Ficha Técnica NACHA-M (DIAN)-M Seguridad Social
```
###### 3. ESQUEMA
...
ANEXOANEXO 4.5. HORARIOSDETALLE DE Y FECHASPLANILLA ESPECIALES DE COMPENSACIÓN (^)
ANEXO 6. EVENTOS SANCIONABLES DEL ESQUEMA DE CALIDAD
ANEXO 7. TIPOS DE NOVEDAD Y CAUSALES
ANEXO 8. FACTURA DE VENTA
ANEXOANEXO 10.11. DEVOLUCIONESAUTORIZACIÓN DE POR RECAUDO SOLICITUD DEL USUARIO RECEPTOR
ANEXO 12. CANCELACIÓN DE AUTORIZACIÓN DE RECAUDO
ANEXO 13. CONTRATO DÉBITO CLIENTE ORIGINADOR – ENTIDAD
PARTICIPANTE ORIGINADORA
ANEXOINTEGRA ACH 14. AUTORIZACIÓN(EF) DE ADMINISTRADORES DE USUARIOS ANTE
ANEXO 16. DESCRIPCIÓN DE LOTE
...
En el marco del proceso de modernización de la plataforma, se ha definido la automatización de la recepción
y entrega de archivos entre ACH Colombia y las entidades participantes.

Para este fin, ACH Colombia implementa el uso de un sistema de Transferencia Administrada de Archivos (MFT,
por sus siglas en inglés), el cual permite automatizar la comunicación con las entidades financieras mediante
la recepción segura de archivos a través del protocolo SFTP y su posterior almacenamiento en contenedores
...
Página 47 de 329
```
El sistema Integra ACH (VolPay) es responsable de consumir los archivos almacenados en Amazon S3 para su
respectivo procesamiento transaccional. De igual forma, los archivos de salida, tales como los archivos de
finalización .OUT , archivos de retornos .RET y las planillas de compensación, serán dispuestos en Amazon S3
para su posterior entrega a las entidades financieras.

```
Arquitectura Objetivo Automatización Intercambio de Archivos
```
Requisitos para tener en cuenta e iniciar la configuración del SFTP entre ACH y la entidad:

- Nuestro sistema MFT (GAW) se conectará al host: URL del SFTP expuesto por la Entidad
- Se realizará el uso del usuario SFTP: Creado e Indicado por la Entidad
- Puerto de conexión en Entidad: Expuesto por la Entidad
- Ruta o directorio a donde dejar el archivo: Indicado por la entidad
- IP de origen (ACH): 129.159.102.124 (La entidad debe permitir en su sistema la conexión desde
esta IP Publica de ACH) Puerto 58537

```
2.4.2.1. Actividades de proceso de automatización
```
- La Entidad deposita los archivos en el SFTP asignado
- GoAnywhere detecta los archivos y ejecuta el flujo configurado para realizar el traspaso de los
- archivos hacia el bucket de Amazon S3 de ACH Colombia.
- Integra consume los archivos desde el bucket de S3
...
Página 48 de 329
```
- Integra realiza su procesamiento automáticamente para el proceso transaccional regular
- Integra entrega los archivos de salida al bucket de S3
- No se va usar cifrado PGP nativo de GAW.
- GoAnywhere detecta los archivos y ejecuta el flujo configurado para realizar la entrega de los
    archivos de salida a la ruta del SFTP de cada entidad financiera
- La entidad financiera debe tener claridad que los formatos que va a enviar y recibir GoAnywhere
    corresponde a un archivo cifrado con criptovault con extensión. env; adicionalmente, el nombre del
    archivo debe contener el código de la entidad conservando la estructura NachaM que hoy en día se
    tiene definida para los archivos de entrada y salida: Ejemplo:
       ➢ 0001122.003.1.env
       ➢ 0001122.002.20260417.1.OUT.env
       ➢ 0001122.003.1Retornos20260421.1.RET.env

```
2.4.2.2. Responsabilidades Entidad Participante
```
La Entidad Financiera es responsable de configurar, operar y asegurar el canal SFTP utilizado para el servicio
ACH Transferencias, garantizando su disponibilidad y correcto funcionamiento. Esto incluye la adecuada
gestión de accesos, credenciales, rutas, permisos y controles de seguridad, de acuerdo con los estándares
técnicos y de nomenclatura definidos por ACH.

Asimismo, debe asegurar la confidencialidad e integridad de los archivos NACHAM, realizando las validaciones
necesarias sobre su estructura y contenido antes de enviarlos. También es responsable de atender
oportunamente errores, códigos de retorno y notificaciones, así como de ejecutar los procedimientos de
contingencia y reintentos en caso de fallas del canal.

ACH procesará los archivos tal como sean recibidos por el SFTP, sin validar su contenido. Por lo tanto, cualquier
error operativo, contable o transaccional derivado de información incorrecta o incompleta será
responsabilidad de la Entidad Financiera.

Finalmente, la Entidad Financiera será responsable por cualquier impacto operativo, de seguridad o regulatorio
que se genere por una gestión inadecuada del canal SFTP bajo su administración.
...
```
− Transacciones Crédito y Débito, Prenotificaciones Crédito y Débito recibidas de los Usuarios
Originadores.
...
```
La Entidad Participante Originadora debe enviar la prenotificación al menos tres (3) días hábiles antes de la
fecha efectiva de la primera transacción de débito, dando tiempo a la Entidad Participante Receptora de
asegurar sus procesos internos, en caso de que así lo requiera. Es de aclarar que operativamente, a través del
sistema administrado por ACH Colombia, es posible enviar la transacción monetaria una vez hayan pasado
cuatro ciclos del envío de la prenotificación original, siempre y cuando esta no haya sido rechazada.
...
```
```
Nota: El control de Límites transaccionales a depósitos electrónicos de manera
mensual establecido en el Decreto 222 de 2020 del Departamento
Administrativo de la Función Pública, no es responsabilidad de ACH Colombia,
toda vez que los participantes del servicio son quienes deben implementar el
mecanismo de control en su infraestructura tecnológica.
```
...
4. El certificado deberá ser compatible con los formatos de entrega PKCS#12 y .cer (x509 V3), para la
    ...
    la firma.
5. Los certificados digitales que requieren firma digital tipo PJEE, se deben gestionar a través de una
    entidad certificadora autorizada por la ONAC, mitigando los riesgos asociados al no repudio.
...
intrusos, sistema antivirus, sistema anti-spam y sistemas de control de navegación de acuerdo con el
...
5.4.2. Recomendaciones con usuarios originadores y receptores
...
```
```
3 CODIGO ENTIDAD DESTINO INMEDIATO M bRRRRRTT
TC
10 4 - 13 Código^ de^ ACH^ COLOMBIA^ (^00 0101006)^ y^ dígito^ de^
chequeo.
```
```
...
3 NOMBRE DEL USUARIO ORIGINADOR M AN 16 5 - 20 Nombre^ del^ Usuario^ Originador^ para^ propósitos^
descriptivos.
...
###### PARTICIPANTE ORIGINADORA M^ RRRRRTTT^8 92 -^99
...
```
```
7 IDENTIFICACION DEL CLIENTE ORIGINADOR R AN 10 57 - 66 Número^ de^ identificación^ del^ Cliente^
Originador.
```
```
...
4 DIGITO DE CHEQUEO M N 1 12 - 12 Dígito de chequeo correspondiente al campo 3.
```
###### 5 NUMERO^ DE^ CUENTA^ DEL^ CLIENTE^
...
```
Código de el participante que envía el archivo y
dígito de chequeo.
```
```
5 FECHA DE CREACION DEL ARCHIVO M AAAAMM
...
###### Y DE REGISTROS ADENDA M^ N^8 14 -^21
...
3 NOMBRE DEL USUARIO ORIGINADOR M AN 16 5 - 20 Nombre^ del^ Usuario^ Originador^ de^ la^ transacción^
original.
...
```
RECEPTOR R^ AN^17 13 -^29 Número^ de^ cuenta^ contenido^ en^ la^ transacción^ original.^
```
...
4 CODIGO ENTIDAD ORIGEN INMEDIATO M
bRRRRRTT
TC 10 14 -^23 Código^ de^ ACH^ COLOMBIA^ (0001^010 06).^
```
```
...
```
```
13 CODIGO DE REFERENCIA O AN 8 89 - 96 Código^ del^ sistema:^ “1”^ o^ blancos.^
```
```
14 RESERVADO N/D Blancos 10 97 - 106 Campo reservado. Este campo debe ir en blancos.
```
...
5
```
###### IDENTIFICACION DEL UISUARIO

###### ORIGINADOR M^ AN^10 41 -^50
...
MDD
8 72 - 79 Fecha^ en^ la^ cual^ ACH^ COLOMBIA^ procesará^ las^
transacciones.
...
```
Número total de registros de detalle y de
...
```
Suma de valores de las transacciones tipo
crédito del archivo.
```
```
8 RESERVADO N/D Blancos 39 68 - 106 Campo reservado no disponible.
...
```
```
3 CÓDIGO DEL PSE R N 4 4 - 7 Número^ de^ Identificación^ del^ proveedor^ de^
...
```
```
15 RESERVADO N/D Blancos 12 95 - 106 Campo^ reservado.^ Este^ campo^ debe^ ir^ en^
blancos.
```
...
```
ORIGINADOR O^ AN^20 21 -^40 Campo^ reservado.^
```
5
...
###### 3 NUMERO^ DE^ TRANSACCIONES^ DETALLADAS^
...
```
Fecha en la cual las Entidad Participante Receptor
deben aplicar las transacciones del lote.
10 FECHA DE COMPENSACIÓN JULIANA O N 3 80 - 82 Fecha de liquidación de las transacciones.
```
```
...
D3 3 Transacción no permitida para la entidad Financiera Receptora
...
Página 236 de 329
```
###### ABREVIATURA DESCRIPCIÓN LARGA DESCRIPCIÓN^
...
```
R01 N/A SI N/A N/A
Fondos Insuficientes: El saldo disponible no es suficiente para cubrir el valor de la
transacción débito.
```
###### R02
...
```
Prenotificación no procesada por
...
```
```
R30 Clientecuenta Receptorasociada ano una^ habilitado persona^ paraNatural^ recibir transacciones^ a^ depósitos^ Electrónicos:^ La^ cuenta^ destino^ no^ es^ una^
```
```
...
Administrador de Usuarios: Su labor principal es administrar los requerimientos de creación, modificación,
eliminación, bloqueo y desbloqueo de usuarios del sistema Transferencias Interbancarias al interior de su
Entidad Participante.
DATOS BÁSICOS DEL ADMINISTRADOR DE USUARIOS PRINCIPAL
...
INFORMACION DE DOMINIO DE CORREO Y SUFIJO DE USUARIOS EN INTEGRA ACH PARA EF
```
DOMINIO DE CORREO: _Escribir los dominios de correos de usuarios de la entidad y externos que requieran acceder
al servicio de transferencias interbancarias. Ejm: funcionarios de la Entidad, contact center, proveedor técnico._

DOMINIO DE CORREO:

SUFIJO DE USUARIOS: _Escribir el sufijo que el usuario de la entidad requiere para acceder al servicio de
transferencias interbancarias. Ejm: Banco Rojo Sufijo: banco rojo usuario/banco rojo_
...
PAGOS Pagos
PRS Pago Sistema de Seguridad Social
Pago Régimen Subsidiado
RECAUDOS Recaudos – Débito Interbancario
TRANSFER Transferencias o traslados
DEVOLUCION Devolución o Devolución de Devolución
PRENOTIFIC Prenota
...
```
32 Aviso Sedevol^ hau^ ccaión.m biado^ información^ de^ la^ transacción^ original^ al^ generar^ la^
```
...
```
12.16
¿Cuándo los resultados de pruebas no son satisfactorios establecen
planes de mejora?
```
```
12.17
