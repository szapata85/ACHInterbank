...
Estado: B2 CERRADA: validada en runtime contra SQL Server y PostgreSQL.
...
- Pruebas: replay con metadatos de transporte distintos, dos `DbContext` y restricción única en SQLite relacional; JOB 3.1 ejecutó la carrera real sobre SQL Server y PostgreSQL con migraciones, índice y base/esquema efímeros de los harnesses existentes. En ambos proveedores hubo una aplicación, un replay controlado, un evento y causal/estado finales correctos.
