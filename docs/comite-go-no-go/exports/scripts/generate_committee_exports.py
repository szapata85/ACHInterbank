...
def generate_excel() -> None:
    ...
    criterios_rows = [
        ...
        ("Seguridad", "PARCIAL", "Revision seguridad", "Si", "Brechas cerradas o aceptadas formalmente", "Seguridad", "ACH.Operator cerrado para UAT; sigue pendiente la custodia corporativa de secretos/certificados."),
        ("Custodia de secretos", "PENDIENTE", "Brechas", "Si", "Gestion de secretos validada", "DevOps/Security", ""),
