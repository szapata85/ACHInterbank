...
- UAT integrado NACHA-M ACH Colombia/CENIT bloqueado por archivo 0 bytes y prenotificacion previa ausente; requiere cierre antes de nuevo comite.
- Proc_Contrapartidas requiere modo UAT/mock o guardrail dry-run; se generaron envelopes XML sanitizados sin invocacion manual.
- CENIT/CUD.
