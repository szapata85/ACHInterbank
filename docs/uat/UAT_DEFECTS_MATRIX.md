...
| UAT-FND-007 | UAT-EXP-003 | Medio | Brecha escenario externo | Ciclo/cola/neteo CENIT ampliado requiere evidencia con operador externo | `EXTERNAL_UAT_WINDOW_PLAN.md`, `EXTERNAL_UAT_EVIDENCE_REQUESTS.md` | Abierto | Operaciones CENIT + DevOps | UAT formal con CENIT | Mantener evidencia sintetica/read-only | Limita cobertura operativa CENIT | Productivo NO-GO | 6D.4: asociado a ventana CENIT W-005/W-006; no cerrar sin tercero |
