...
Estados permitidos: `Pendiente`, `Recibido sin cargar`, `Validado por seguridad`, `Cargado en ambiente aislado`, `Bloqueado`, `No aplica`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CERT-ACH-CLIENT-001 | ACH Colombia | Certificado cliente | UAT aislado | ACH Colombia | CFA Seguridad | Pendiente | Por definir | Acta entrega segura sin material secreto | No cargar sin aprobacion |
...
| END-ACH-SOAP-001 | ACH Colombia | Endpoint SOAP | UAT aislado | ACH Colombia | CFA Tecnologia | Pendiente | Por definir | Matriz endpoint aprobada sin URL real | SOAP bloqueado hasta autorizacion |
...
| CERT-CEN-CLIENT-001 | Banco Republica/CENIT | Certificado cliente | UAT aislado | CENIT | CFA Seguridad | Pendiente | Por definir | Acta entrega segura sin material secreto | Placeholder |
...
| END-CEN-SOAP-001 | Banco Republica/CENIT | Endpoint SOAP | UAT aislado | CENIT | CFA Tecnologia | Pendiente | Por definir | Matriz endpoint aprobada sin URL real | SOAP bloqueado hasta autorizacion |
