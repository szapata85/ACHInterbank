        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestFingerprintHash = table.Column<string>(type: "nchar(64)", fixedLength: true, maxLength: 64, nullable: false),
                    Sequence = table.Column<int>(type: "int", nullable: false),
                    FileIdModifier = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    ExternalFileName = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[GenerationReservationId] IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ExternalFileNameRegistry_ExternalFileNameReservations_GenerationReservationId",
                table: "ExternalFileNameRegistry",
                column: "GenerationReservationId",
