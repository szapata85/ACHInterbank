        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceResponseId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    SourceFileName = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
                    ResponseType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ResultingState = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ReasonCode = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ReceivedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProcessedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CorrelationOutcome = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    RawTechnicalReference = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ...
                    RelatedOutboundFileName = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: true),
                    RelatedReference = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    TransactionTraceNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ProblemCode = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
