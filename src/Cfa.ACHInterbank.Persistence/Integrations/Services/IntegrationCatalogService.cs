...
public class IntegrationCatalogService : IIntegrationCatalogService
{
    ...
    private static IReadOnlyCollection<SourceSeedSpec> BuildBusinessSourceCatalog(int methodId)
    {
        ...
        [
            ...
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(FinancialInstitution), "sourceInstitution.coreBankCode", "Código core banco originador", "string", false, order++),
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(FinancialInstitution), "destinationInstitution.coreBankCode", "Código core CFA receptora", "string", false, order++),
