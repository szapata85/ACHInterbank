...
public sealed class IntegrationCatalogBootstrapper
{
    ...
    private static IReadOnlyCollection<SourceSeedSpec> BuildBusinessSourceCatalog(int methodId)
    {
        ...
        [
            ...
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(FinancialInstitution), "sourceInstitution.coreBankCode", "Codigo core banco originador", "string", false, order++),
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(FinancialInstitution), "destinationInstitution.coreBankCode", "Codigo core CFA receptora", "string", false, order++),
