...
public sealed class IntegrationCatalogBootstrapper
{
    ...
    private static IReadOnlyCollection<ParameterSeedSpec> BuildProcTransaccionesTechnicalCatalog()
    {
        ...
        return
        [
            Spec("TREG", "Tipo de registro", "Tipo de registro ACH transaccion.", "Entrada transaccion", "6", "Tipo de registro segun layout ACH.", "string", false, i++),
            ...
            Spec("CONV", "Convenio", "Codigo de convenio.", "Entrada transaccion", "CNV01", "Convenio aplicable a la operacion.", "string", false, i++),
            Spec("PROD", "Producto", "Codigo de producto.", "Entrada transaccion", "ACH", "Producto financiero asociado.", "string", false, i++),
            ...
            Spec("REGLOTE", "Registro lote", "Registro secuencial de lote.", "Entrada transaccion", "1", "Numero de registro en lote.", "long", false, i++),
            Spec("IREVER", "Indicador reverso", "Indicador de reverso.", "Entrada transaccion", "0", "0 normal, 1 reverso.", "int", true, i++),
            Spec("LIBRE", "Campo libre", "Campo libre texto.", "Entrada transaccion", "OBS", "Campo complementario opcional.", "string", false, i++),
            Spec("IDCAMCOMPE", "Id camara", "Id camara compensadora.", "Entrada transaccion", "12", "Id de camara vigente.", "int", true, i++),
            Spec("DIRECCIONIP", "Direccion IP", "IP de origen.", "Entrada transaccion", "10.10.10.1", "IP para trazabilidad.", "string", false, i++),
            Spec("LIBRE1", "Campo libre numerico", "Campo libre numerico.", "Entrada transaccion", "1", "Campo complementario numerico.", "int", false, i++),
    ...
    private static IReadOnlyCollection<SourceSeedSpec> BuildBusinessSourceCatalog(int methodId)
    {
        ...
        [
            ...
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(AchTransaction), "transaction.destinationAccountNumber", "Cuenta receptora", "string", false, order++),
            ...
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(FinancialInstitution), "sourceInstitution.transitCodeNormalized", "Código de tránsito normalizado del banco originador", "string", false, order++),
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(FinancialInstitution), "destinationInstitution.transitCodeNormalized", "Código de tránsito normalizado de la CFA receptora", "string", false, order++),
            Source(methodId, IntegrationSourceKindEnum.Transaction, nameof(FinancialInstitution), "sourceInstitution.name", "Nombre originador", "string", false, order++),
            Source(methodId, IntegrationSourceKindEnum.Transaction, "ProcTransacciones", "procTransacciones.paymentInformation", "Informacion pago homologada 77", "string", false, order++),
            Source(methodId, IntegrationSourceKindEnum.Transaction, "ProcTransacciones", "procTransacciones.functionalBatchId", "Lote funcional D6", "string", false, order++),
            ...
            Source(methodId, IntegrationSourceKindEnum.Cycle, nameof(AchCycle), "cycle.clearingHouseId", "Id canonico camara", "int", false, order++),
