...
internal static class SchedulerTaskCatalog
{
    ...
    [
        ...
        new(
            "ACHCOL_MFT_OUTBOUND",
            "AchColombiaManagedMftOutbound",
            "Enviar archivos a ACH Colombia",
            "Entrega archivos oficiales por la frontera administrada.",
            "Intercambio de archivos ACH Colombia",
            "Envío de archivo",
            null,
            true,
            false,
        ...
        new(
            "ACHCOL_MFT_INBOUND",
            "AchColombiaManagedMftInbound",
            "Recibir archivos de ACH Colombia",
            "Recibe y procesa archivos disponibles en la frontera administrada.",
            "Intercambio de archivos ACH Colombia",
