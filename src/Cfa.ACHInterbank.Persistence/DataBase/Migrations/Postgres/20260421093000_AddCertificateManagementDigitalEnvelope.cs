    ...
    public partial class AddCertificateManagementDigitalEnvelope : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_DigitalCertificates", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CertificateLoadAudits_DigitalCertificateVersions_CertificateVers~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CertificateRotationHistories_DigitalCertificateVersions_NewVers~",
                        column: x => x.NewVersionId,
                        principalTable: "DigitalCertificateVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CertificateRotationHistories_DigitalCertificateVersions_Previo~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CertificateUsageLogs_DigitalCertificateVersions_CertificateVers~",
                        column: x => x.CertificateVersionId,
                        principalTable: "DigitalCertificateVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DigitalEnvelopeOperationLogs_DigitalCertificateVersions_Certifi~",
                        column: x => x.CertificateVersionId,
                        principalTable: "DigitalCertificateVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(name: "IX_DigitalCertificates_Code", table: "DigitalCertificates", column: "Code", unique: true);
            migrationBuilder.CreateIndex(name: "IX_DigitalCertificateVersions_ClearingHouseId_Environment_Purpose_HolderType", table: "DigitalCertificateVersions", columns: new[] { "ClearingHouseId", "Environment", "Purpose", "HolderType" });
            migrationBuilder.CreateIndex(name: "IX_DigitalCertificateVersions_DigitalCertificateId", table: "DigitalCertificateVersions", column: "DigitalCertificateId");
            migrationBuilder.CreateIndex(name: "IX_DigitalCertificateVersions_NotAfter", table: "DigitalCertificateVersions", column: "NotAfter");
            migrationBuilder.CreateIndex(name: "IX_DigitalCertificateVersions_ReplacedByVersionId", table: "DigitalCertificateVersions", column: "ReplacedByVersionId");
            migrationBuilder.CreateIndex(name: "IX_DigitalCertificateVersions_SerialNumber", table: "DigitalCertificateVersions", column: "SerialNumber");
            migrationBuilder.CreateIndex(name: "IX_DigitalCertificateVersions_Thumbprint", table: "DigitalCertificateVersions", column: "Thumbprint");
            migrationBuilder.CreateIndex(name: "UX_DCV_Active_Context", table: "DigitalCertificateVersions", columns: new[] { "ClearingHouseId", "Environment", "Purpose", "HolderType" }, unique: true, filter: "\"Status\" = 2");
            migrationBuilder.CreateIndex(name: "IX_CertificateLoadAudits_CertificateVersionId", table: "CertificateLoadAudits", column: "CertificateVersionId");
            migrationBuilder.CreateIndex(name: "IX_CertificateLoadAudits_LoadedAtUtc", table: "CertificateLoadAudits", column: "LoadedAtUtc");
            migrationBuilder.CreateIndex(name: "IX_CertificateRotationHistories_NewVersionId", table: "CertificateRotationHistories", column: "NewVersionId");
            migrationBuilder.CreateIndex(name: "IX_CertificateRotationHistories_PreviousVersionId_NewVersionId", table: "CertificateRotationHistories", columns: new[] { "PreviousVersionId", "NewVersionId" }, unique: true);
            migrationBuilder.CreateIndex(name: "IX_CertificateUsageLogs_CertificateVersionId", table: "CertificateUsageLogs", column: "CertificateVersionId");
            migrationBuilder.CreateIndex(name: "IX_CertificateUsageLogs_OccurredAtUtc", table: "CertificateUsageLogs", column: "OccurredAtUtc");
            migrationBuilder.CreateIndex(name: "IX_CertificateUsageLogs_Result", table: "CertificateUsageLogs", column: "Result");
            migrationBuilder.CreateIndex(name: "IX_DigitalEnvelopeOperationLogs_CertificateVersionId", table: "DigitalEnvelopeOperationLogs", column: "CertificateVersionId");
            migrationBuilder.CreateIndex(name: "IX_DigitalEnvelopeOperationLogs_OccurredAtUtc_ClearingHouseId_Environment_Purpose_Result", table: "DigitalEnvelopeOperationLogs", columns: new[] { "OccurredAtUtc", "ClearingHouseId", "Environment", "Purpose", "Result" });
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "CertificateLoadAudits");
            migrationBuilder.DropTable(name: "CertificateRotationHistories");
            migrationBuilder.DropTable(name: "CertificateUsageLogs");
            migrationBuilder.DropTable(name: "DigitalEnvelopeOperationLogs");
            migrationBuilder.DropTable(name: "DigitalCertificateVersions");
            migrationBuilder.DropTable(name: "DigitalCertificates");
        }
    }
}
