...
public class GenerateTokenTransient : IDisposable, IGenerateTokenTransient
{
    ...
    private readonly IGenerateTokenExternalTransient _tokenExternal;
    private readonly ITokenRepositorySingleton _tokenRepository;
    private readonly IClientAssertionValidatorScoped _clientAssertion;
    private readonly AppSettings _appSettings = AppSettings.Settings;

    public GenerateTokenTransient(ILoggerManagerTransient logger, IGenerateTokenExternalTransient tokenExternal, ITokenRepositorySingleton tokenRepository, IClientAssertionValidatorScoped clientAssertion)
    {
        _logger = logger;
