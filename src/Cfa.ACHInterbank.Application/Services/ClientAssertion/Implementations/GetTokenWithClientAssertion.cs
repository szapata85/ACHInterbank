...
[Scoped]
public class GetTokenWithClientAssertion : IGetTokenWithClientAssertion
{
    ...
    public GetTokenWithClientAssertion(IKeysRepository keysRepository, IHttpClientService httpClient)
    {
