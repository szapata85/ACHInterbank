...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'certificates', component: NachaCertificateManagerComponent, data: { breadcrumb: 'Certificados digitales', title: 'Certificados digitales', permissions: ['Certificates.Read', NACHA_SECURITY_PERMISSIONS.canManageCertificates, NACHA_SECURITY_PERMISSIONS.canReadAch] } },
