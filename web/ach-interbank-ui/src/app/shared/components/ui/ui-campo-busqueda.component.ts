...
@Component({
  ...
  `,
  styles: [`.ui-campo-busqueda{display:grid;grid-template-columns:auto 1fr auto;gap:.35rem;align-items:center;border:1px solid var(--color-border-strong);border-radius:var(--radius-md);padding:0 .5rem;min-height:var(--control-height);background:#fff}.ui-campo-busqueda input{border:none;outline:none}.limpiar{border:none;background:transparent;color:var(--color-primary);cursor:pointer}`]
})
